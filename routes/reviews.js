 ...
 * Ambil list ulasan untuk 1 tempat + summary rating
 */
router.get("/reviews/:placeId", async (req, res) => {
  ...
  try {
    ...
    // 2) Summary (avg, total, distribusi bintang)
    // Catatan: SUM(rating = 5) di MySQL menghasilkan 0/1 yang bisa dijumlahkan.
 ...
 * Ringkasan rating untuk semua tempat
 * (dipakai di Home.jsx / list card)
 */
